...
```
    ...
    ({'max_depth': 5}, 0.8338133333333333)
...
```
    ...
    The accuracy score without hyperparameter optimization is 82.94%
...
```
    ...
    array([0.03441052, 0.19374371, 0.04650523, 0.02892607, 0.1815213 ,
           0.24258672, 0.07579023, 0.03936812, 0.03315933, 0.08457714,
           0.03941162])
...
```
    ...
    The accuracy score with PCA is 82.25%
...
```
    ...
    The accuracy score is 82.64%
    

The accuracy has not improved. It is not better than the Gradient Boosting Classifier.
